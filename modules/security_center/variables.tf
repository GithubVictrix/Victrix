...
variable "security_center_workspaces_id" {
  description = ""
  type        = string
}
...
variable "security_center_auto_provisioning" {
  description = "When you enable an extension, it will be installed on any new or existing resource, by assigning a security policy"
  type        = string
  default     = "On" 
}
